                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        border: `2px dashed ${isSelfSign ? '#f59e0b' : `hsl(var(--${box.color}))`}`,
                        borderRadius: "10px",
                        background: isSelfSign ? 'rgba(245, 158, 11, 0.05)' : 'transparent',
          ...
          <div style={{ width: "300px", flexShrink: 0 }}>
            <div style={{
              ...
              <h3 style={{ fontFamily: "Space Grotesk, sans-serif", fontSize: "16px", fontWeight: 700, color: "#0f172a", marginBottom: "16px" }}>
                {signingType === "self" ? "Self Signing" : "Signers"}
              </h3>
                  ...
                  signatureBoxes.map((box) => (
                    <div
                      ...
                      style={{
                        ...
                        background: box.signed ? t.signedBg : t.selfSignBg,
                        transition: "all 0.2s",
                      }}
                    >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                        ...
                        <span style={{ fontSize: "12px", fontWeight: 500, color: box.signed ? t.signedColor : t.pendingColor }}>
                          {box.signed ? "Signed ✓" : "Pending"}
                        </span>
                      </div>
                    </div>
                  ))
              ...
              {mode === "issue" && (
                ...
                >
                  <CheckCircle size={18} />
                  {processing ? "Issuing..." : (signingType === "self" ? "Issue Self-Signed Credential" : "Issue Credential")}
                </button>
              )}
            </div>
          </div>
