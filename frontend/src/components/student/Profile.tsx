...
const StudentProfile: React.FC = () => {
    ...
    const accent = "#1e1a6b";
    const fields = [
        { icon: <User size={18} color={accent} />, label: "Full Name", value: fullName },
        ...
        { icon: <Calendar size={18} color={accent} />, label: "Age", value: user.age ? `${user.age} years` : "—" },
        { icon: <Shield size={18} color={accent} />, label: "Role", value: user.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : "Student" },
    ];
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", width: "100%", maxWidth: "540px", textAlign: "left" }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px" }}>
                        ...
                        <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#0f172a" }}>Wallet Public Key</h3>
                    </div>
